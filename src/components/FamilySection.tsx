...
const DEFAULT_FAMILY_PHOTO = '/one.png';
...
export const FamilySection: React.FC = () => {
  ...
  return (
    <section
      id="family"
      className="relative py-20 sm:py-28 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#FFFDF7] border-t border-[#D4AF67]/40 scroll-mt-24 sm:scroll-mt-28"
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className="relative rounded-3xl p-3 sm:p-5 bg-gradient-to-br from-[#EFE6CE] via-[#FAF5E8] to-[#E3D4B0] border-2 border-[#D4AF67] transition-all duration-500 shadow-xl"
        >
          {/* Inner Ornate Frame */}
